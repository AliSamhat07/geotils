...
autodoc_mock_imports = ['icecream', 'segmentation-models-pytorch', 'tmp', 'utils', 'pystac', 'imantics', 'timm', 'supermercado', 'cv2','imantics', 'simplification', 'mercantile', 'colorama', 'albumentations', 'torchvision', 'color_map', 'shapely', 'PIL', 'tabulate', 'ToBeChecked', 'Dataset', 'fcntl', 'yacs','skimage', 'rasterio', 'tqdm', 'matplotlib', 'sklearn', 'geopandas', 'pandas', 'numpy', 'torch', 'yaml']
